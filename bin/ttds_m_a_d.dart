void main(List<String> arguments) {
  // Class Three
  // Methods and Functions - Block Codes/Grouped Codes
  // Methods can reused
  showHelloWorld();
  myName();
  courseTitle();
  ...
  signUpTwo(email: "ifeanyiboby@gmail",phoneNumber: "87897",fullname: "Ifeanyi",password: "oiuyty87",gender: "Female");
...
void signUp(String email, String password,[String fullname='No name', String phoneNumber='+234', String gender='Male']){
  print('Sign up successful');
}

// Scenerio 3&4b - Another pattern for overload
void signUpTwo({String email='', String password='',String fullname='No name', String phoneNumber='+234', String gender='Male'}){
  print('Sign up successful');
}

// Scenerio 3&4c - Another pattern for overload
void signUpThree(String email, {String password='',String fullname='No name', String phoneNumber='+234', String gender='Male'}){
  print('Sign up successful');
}

// Scenerio 3&4d - Another pattern for overload
void signUpFour(String email, {required String password,String fullname='No name', String phoneNumber='+234', String gender='Male'}){
  print('Sign up successful');
}
